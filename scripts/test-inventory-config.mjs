...
export const groups = [
  ...
  group('WhatsApp dispatch', 'conditional', 'contract-unit', ['whatsappDispatch', 'whatsappConversation'], 'consent / STOP / scheduler rules / whatsapp-dispatch handler (not a live cron run)'),
