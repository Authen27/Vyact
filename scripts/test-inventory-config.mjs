...
export const groups = [
  ...
  group('WhatsApp dispatch', 'conditional', 'contract-unit', ['whatsappDispatch', 'whatsappConversation', 'whatsappFollowups'], 'consent / STOP / scheduler rules / follow-up conversations / whatsapp-dispatch handler (not a live cron run)'),
