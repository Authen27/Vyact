...
export const groups = [
  ...
  group('Ask Vyact', 'conditional', 'unit', ['askVyact', 'askVyactFacts', 'askVyactContract', 'agentRouter', 'agentRelay'], 'runAssistant / resolve facts / router / Claude Code relay (test-only)'),
  ...
  group('WhatsApp dispatch', 'conditional', 'contract-unit', ['whatsappDispatch', 'whatsappConversation', 'whatsappFollowups', 'whatsappTemplateSenders', 'whatsappTemplateValidation'], 'consent / STOP / scheduler rules / follow-up conversations / whatsapp-dispatch handler (not a live cron run)'),
