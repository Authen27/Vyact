...
|---|---|---|---|---|---|
| `react/` | **Consumer (React)** | **v10.11.0** | [vyact-twentyx.vercel.app](https://vyact-twentyx.vercel.app) | Vite · React 18 · TS · Tailwind · Recharts · Zustand · Supabase | `cd react && npm install && npm run dev` → `:5173` |
| `admin/` | **Admin** | **v1.3.1** | [vyact-admin.vercel.app](https://vyact-admin.vercel.app) | Vite · React 18 · TS · Tailwind · Recharts · Supabase | `cd admin && npm install && npm run dev` → `:5174` |
