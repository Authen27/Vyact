...
|---|---|---|---|---|---|
| `react/` | **Consumer (React)** | **v10.32.0** | [vyact-twentyx.vercel.app](https://vyact-twentyx.vercel.app) | Vite · React 18 · TS · Tailwind · Recharts · Zustand · Supabase | `cd react && npm install && npm run dev` → `:5173` |
