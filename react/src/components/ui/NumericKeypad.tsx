 ...
 *  v10.35.0 — no longer auto-focuses. A programmatic focus on a real mobile
 *  input pops the OS keyboard immediately on open, and Chrome's own
 *  autofill-candidate outline showed up around it uninvited; the field is
 *  the first, largest control on the page and still an obvious first tap. */
