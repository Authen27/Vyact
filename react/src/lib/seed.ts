...
export function buildSeed(): SeedBundle {
  ...
  const transactions: Transaction[] = [
    ...
    { id:uid(), type:'expense', amount:2340, category:'rent',        description:'Mortgage Payment',   date:`${mk}-01`, memberId:alexId, recurring:'monthly', currency:'USD', paymentMethod:'wells' },
    { id:uid(), type:'expense', amount:280,  category:'food',        description:'Weekly Groceries',   date:`${mk}-05`, memberId:samId,  recurring:'weekly',  currency:'USD', note:'Whole Foods', paymentMethod:'visa' },
    ...
    { id:uid(), type:'expense', amount:320,  category:'food',        description:'Restaurants',        date:`${mk}-14`, memberId:alexId, currency:'USD', note:'Family', paymentMethod:'amex' },
    { id:uid(), type:'investment', amount:500, category:'investment_in', description:'Vanguard Buy',  date:`${mk}-15`, memberId:alexId, recurring:'monthly', currency:'USD', paymentMethod:'chase', note:'DCA into VTSAX' },
    ...
    { id:uid(), type:'expense', amount:2340, category:'rent',        description:'Mortgage',           date:`${prev1}-01`, memberId:alexId, recurring:'monthly', currency:'USD', paymentMethod:'wells' },
    { id:uid(), type:'expense', amount:310,  category:'food',        description:'Groceries',          date:`${prev1}-05`, memberId:samId,  currency:'USD', paymentMethod:'visa' },
    ...
    { id:uid(), type:'investment', amount:500, category:'investment_in', description:'Vanguard Buy',  date:`${prev1}-15`, memberId:alexId, recurring:'monthly', currency:'USD', paymentMethod:'chase' },
    // 2 months ago
    ...
    { id:uid(), type:'expense', amount:2340, category:'rent',        description:'Mortgage',           date:`${prev2}-01`, memberId:alexId, recurring:'monthly', currency:'USD', paymentMethod:'wells' },
    { id:uid(), type:'expense', amount:295,  category:'food',        description:'Groceries',          date:`${prev2}-06`, memberId:samId,  currency:'USD', paymentMethod:'visa' },
