...
- Consumer: [`react/CHANGELOG.md`](react/CHANGELOG.md) — **current v9.9.0**
- Admin: [`admin/CHANGELOG.md`](admin/CHANGELOG.md) — **current v1.3.0**
...
└── admin/                  — ADMIN app (v1.3.0, separate product)
