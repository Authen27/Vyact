...
export const VOCAB_EN: GrammarVocabulary = {
  ...
  categories: {
    ...
    taxi: 'transport', cab: 'transport', ola: 'transport', train: 'transport',
    bus: 'transport', metro: 'transport', parking: 'transport', toll: 'transport',
...
export const VOCAB_HINGLISH: GrammarVocabulary = {
  ...
  categories: {
    ...
    safar: 'transport', auto: 'transport', rickshaw: 'transport', petrol_pump: 'transport',
