...
**28 items total — 21 ✅ resolved · 4 ⚠ partial · 3 ⬜ open.**
...
5. **TD-25** — `store.ts` → Zustand slices. L; per-slice PRs under the test net, byte-identical `useStore`. **Next up.**
