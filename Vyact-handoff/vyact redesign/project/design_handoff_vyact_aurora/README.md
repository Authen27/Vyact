...
> **Purpose:** Completely redesign the existing app's **look** (design tokens / visual language) and **navigation UX** (desktop + mobile) to the **"Aurora"** direction. This is a **visual + navigation redesign** — all business logic, data models, routes, and features are preserved.
...
- `Vyact App v2 · Aurora.html` — **desktop** target (open this first).
- `Vyact Mobile · Aurora.html` — **mobile** target (full-bleed < 640px; gallery on desktop).
